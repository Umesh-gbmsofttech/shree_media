      ...
      <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-16">
        <div className="lg:w-1/2">
          <h2 className="text-5xl lg:text-7xl font-black text-slate-900 leading-tight tracking-tighter">
            Complete Print Partner <br /> for Every Industry
          </h2>
          <div className="mt-8 space-y-4">
            {['Industrial, packaging, gift, outdoor and indoor printing under one roof', 'Custom box, label, pouch and merchandising solutions for your products', 'Consistent quality, fast delivery and flexible order quantities'].map((item, idx) => (
